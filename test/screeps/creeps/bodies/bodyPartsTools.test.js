...
describe("/screeps/creeps/bodies/bodyPartsTools", function() {
	...
	describe("balance50100MoveParts()", function() {
		...
		it("should return 3 moves, 1 50s, 4 100s for 550 to 599 and max 50s of 1", function() {
	...
	describe("balance50100MoveParts()", function() {
		...
		// NOTE: This could only balance between 2 to -1 unused
		it("should return 2 moves, 1 50s, 2 100s for 550 to 599 and max 50s of 1", function() {
